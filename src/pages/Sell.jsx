    ...
    <Layout>
      <div className="min-h-screen bg-gray-50 ">
        <div className="container mx-auto px-4 md:px-10 py-8">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-6">Sell on GreenFeather</h1>
          <div className="flex gap-6">
            ...
            <main className="flex-1">
              <div className="bg-white  rounded-xl p-4 mb-4">
                <h2 className="text-xl font-semibold text-gray-800">Start selling with confidence</h2>
                <p className="text-gray-600 text-sm mt-1">Explore categories and see what customers love. Boost your listings with best practices.</p>
              </div>
